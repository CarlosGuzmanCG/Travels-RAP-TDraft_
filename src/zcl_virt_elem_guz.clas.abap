CLASS zcl_virt_elem_guz DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_virt_elem_guz IMPLEMENTATION.
  METHOD if_sadl_exit_calc_element_read~calculate.

    DATA lt_original_data TYPE STANDARD TABLE OF z_c_travel_guz WITH DEFAULT KEY.
